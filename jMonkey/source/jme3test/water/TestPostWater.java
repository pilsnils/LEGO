...
//        mainScene.addLight(l);
        ...
        getCam().setLocation(new Vector3f(-327.21957f, 61.6459f, 126.884346f));
        getCam().setRotation(new Quaternion(0.052168474f, 0.9443102f, -0.18395276f, 0.2678024f));
...
//        
        ...
        uw = getCam().getLocation().y < waterHeight;

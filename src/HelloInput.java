...
private LinkedList<legoObject> objects;
  ...
  public void simpleInitApp() {
      ...
      this.objects.add(new legoObject(0, new meshHexagon(), assetManager));
    
      rootNode.attachChild(this.objects.get(0).getGeometry());
    
    player = this.objects.get(0).getGeometry();
